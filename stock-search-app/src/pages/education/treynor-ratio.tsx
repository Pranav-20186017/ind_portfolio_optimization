      ...
      <Container maxWidth="lg" sx={{ py: 4 }}>
        ...
        <Paper elevation={2} sx={{ p: 4, mb: 4 }}>
          ...
          <Typography paragraph>
            <strong>Treynor Ratio</strong> (invented by Jack Treynor, 1965) gauges <em>how much excess return</em> a portfolio delivers <strong>per unit of systematic risk</strong> (<Link href="/education/capm-beta" passHref><MuiLink>β</MuiLink></Link>).
        ...
        <Paper elevation={2} sx={{ p: 4, mb: 4 }}>
            ...
            <Table>
              ...
              <TableBody>
                ...
                <TableRow>
                  ...
                  <TableCell>Portfolio <Link href="/education/capm-beta" passHref><MuiLink>CAPM beta</MuiLink></Link> (relative volatility to market)</TableCell>
                </TableRow>
              </TableBody>
            </Table>
          </TableContainer>
          ...
          <Box sx={{ p: 2, bgcolor: '#f8f9fa', borderRadius: 1, borderLeft: '4px solid #3f51b5', my: 2 }}>
            <Typography paragraph>
              Contrast with <Link href="/education/sharpe-ratio" passHref><MuiLink>Sharpe Ratio</MuiLink></Link>, which divides by <strong>total</strong> volatility (<InlineMath math="\sigma" />).
        ...
        <Paper elevation={2} sx={{ p: 4, mb: 4 }}>
          ...
          <Typography paragraph>
            From <Link href="/education/capm" passHref><MuiLink>CAPM (Capital Asset Pricing Model)</MuiLink></Link>:
          </Typography>
          ...
          <Typography paragraph>
            A <strong>higher</strong> <InlineMath math="T" /> implies positive <Link href="/education/jensens-alpha" passHref><MuiLink>Jensen's Alpha</MuiLink></Link>; <strong>lower</strong> implies under-performance.
          </Typography>
        </Paper>
        ...
        <Paper elevation={2} sx={{ p: 4, mb: 4 }}>
          ...
          <Box sx={{ mt: 2 }}>
            <ul>
              ...
              <li>
                <Typography component="div">
                  <Link href="/education/capm-beta" passHref><MuiLink>β</MuiLink></Link> comes from daily OLS regression against the chosen benchmark.
                </Typography>
              </li>
            </ul>
          </Box>
          ...
          <TableContainer component={Paper} elevation={0} sx={{ mb: 3 }}>
            <Table>
              ...
              <TableBody>
                ...
                <TableRow>
                  <TableCell><strong>≈ MRP</strong></TableCell>
                  <TableCell>In-line with <Link href="/education/capm" passHref><MuiLink>CAPM</MuiLink></Link> expectations</TableCell>
                </TableRow>
                <TableRow>
                  <TableCell><strong>&lt; MRP</strong></TableCell>
          ...
          <Grid container spacing={2}>
            ...
            <Grid item xs={12} sm={6} md={4}>
              <Box sx={{ p: 2, border: '1px solid #e0e0e0', borderRadius: 1, height: '100%' }}>
                ...
                <Link href="/education/jensens-alpha" passHref>
                  <Button variant="contained" color="primary">
                    Learn More
                  </Button>
                </Link>
