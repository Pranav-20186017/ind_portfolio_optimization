          ...
          <Grid container spacing={2}>
            <Grid item xs={12} md={6}>
              <Box sx={{ p: 2, border: '1px solid #e0e0e0', borderRadius: 1, height: '100%' }}>
                ...
                <Typography paragraph>
                  While <MuiLink component={Link} href="/education/volatility">standard deviation</MuiLink> measures dispersion of returns around the mean (both positive and negative), the Ulcer Index only considers negative deviations from peak values. Standard deviation treats a 5% gain and a 5% loss as equivalent in risk terms, whereas the Ulcer Index completely ignores positive movements and focuses on the depth and duration of drawdowns.
                </Typography>
              </Box>
            </Grid>
            <Grid item xs={12} md={6}>
          ...
          <Grid container spacing={2}>
            ...
            <Grid item xs={12} sm={6} md={4}>
              <Box sx={{ p: 2, border: '1px solid #e0e0e0', borderRadius: 1, height: '100%' }}>
                ...
                <Link href="/education/maximum-drawdown" passHref>
                  <Button variant="contained" color="primary">Learn More</Button>
                </Link>
              </Box>
            </Grid>
