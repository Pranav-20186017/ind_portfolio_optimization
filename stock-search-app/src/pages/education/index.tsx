...
const EducationIndexPage: React.FC = () => {
  ...
  const optimizationMethods = [
    ...
    },
    {
      ...
      path: '/education/max-quadratic-utility',
      available: true
    },
    {
  ...
  const quantitativeMetrics = [
    ...
    },
    {
      ...
      path: '/education/conditional-value-at-risk',
      available: true
    },
    {
    ...
    },
    {
      ...
      path: '/education/information-ratio',
      available: false
    },
    {
  ...
  return (
    <>
      <Head>
        <title>Portfolio Optimization Education | Learn About Financial Optimization</title>
      ...
      <Container maxWidth="lg" sx={{ py: 4 }}>
        ...
        <Box sx={{ mb: 6, textAlign: 'center' }}>
          <Typography variant="h3" component="h1" gutterBottom>
            Portfolio Optimization Education
          </Typography>
        ...
        <Paper elevation={2} sx={{ p: 4, mb: 5 }}>
          ...
          <Typography paragraph>
            The educational resources provided here aim to demystify the complex mathematical and financial concepts behind portfolio
