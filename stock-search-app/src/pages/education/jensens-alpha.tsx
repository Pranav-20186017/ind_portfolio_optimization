      ...
      <Container maxWidth="lg" sx={{ py: 4 }}>
        ...
        <Paper elevation={2} sx={{ p: 4, mb: 4 }}>
          ...
          <Typography paragraph>
            ...
            for the risk it takes relative to the market, as prescribed by the <Link href="/education/capm" passHref>
          ...
          <Typography paragraph>
            ...
            what <Link href="/education/capm-beta" passHref><MuiLink>β</MuiLink></Link>-driven market exposure explains.
          </Typography>
        ...
        <Paper elevation={2} sx={{ p: 4, mb: 4 }}>
          ...
          <Typography paragraph>
            Jensen's Alpha is derived from the <Link href="/education/capm" passHref><MuiLink>Capital Asset Pricing Model (CAPM)</MuiLink></Link> regression equation:
          </Typography>
        ...
        <Paper elevation={2} sx={{ p: 4, mb: 4 }}>
          ...
          <Box sx={{ mt: 2, ml: 4 }}>
            ...
            <Typography component="div">
              • <InlineMath math="\hat{\beta}" /> — market <Link href="/education/capm-beta" passHref><MuiLink>beta</MuiLink></Link>
            </Typography>
            <Typography component="div">
