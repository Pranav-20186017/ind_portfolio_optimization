      ...
      <Container maxWidth="lg" sx={{ py: 4 }}>
            ...
            <Grid container spacing={2}>
                ...
                <Box sx={{ p: 2, border: '1px solid #e0e0e0', borderRadius: 1, height: '100%' }}>
                  ...
                  <Typography variant="body2">
                    <ul>
                      ...
                      <li>Affects the entire market (e.g., economic cycles, interest rates)</li>
                      <li>Investors are rewarded with a risk premium for bearing this risk</li>
                      <li>Measured by beta (β)</li>
                    </ul>
                  </Typography>
                </Box>
              </Grid>
              <Grid item xs={12} md={6}>
                <Box sx={{ p: 2, border: '1px solid #e0e0e0', borderRadius: 1, height: '100%' }}>
                  ...
                  <Typography variant="body2">
                    <ul>
                      <li>Can be eliminated through diversification</li>
                      <li>Specific to individual stocks or sectors</li>
                      <li>No expected premium for bearing this risk</li>
                      <li>Examples: company scandals, management changes, product failures</li>
                    </ul>
                  </Typography>
                </Box>
              </Grid>
          ...
          <ul>
            <li>
              <Typography component="div">
                <InlineMath math="\operatorname{Cov}(R_i,R_m)" /> is the covariance between the asset's returns and market returns
              </Typography>
            </li>
            <li>
              <Typography component="div">
                <InlineMath math="\operatorname{Var}(R_m)" /> is the variance of market returns
              </Typography>
            </li>
            <li>
              <Typography component="div">
                <InlineMath math="\rho_{i,m}" /> is the correlation coefficient between the asset and market
              </Typography>
            </li>
            <li>
              <Typography component="div">
                <InlineMath math="\sigma_i" /> is the standard deviation of the asset's returns
              </Typography>
            </li>
            <li>
              <Typography component="div">
                <InlineMath math="\sigma_m" /> is the standard deviation of market returns
              </Typography>
            </li>
          </ul>
        </Paper>
            ...
            <Grid container spacing={2}>
              <Grid item xs={12} md={6}>
                <ol>
                  <li>
                    <Typography component="div">
                      <strong>Mean-variance investors</strong> — Investors care only about expected return and variance of their portfolios.
                    </Typography>
                  </li>
                  <li>
                    <Typography component="div">
                      <strong>Single-period horizon</strong> — All investors have the same evaluation period.
                    </Typography>
                  </li>
                  <li>
                    <Typography component="div">
                      <strong>Homogeneous expectations</strong> — All investors foresee the same expected returns and covariance matrix.
                    </Typography>
                  </li>
                </ol>
              </Grid>
              <Grid item xs={12} md={6}>
                <ol start={4}>
                  <li>
                    <Typography component="div">
                      <strong>Perfect markets</strong> — No taxes, trading frictions, or short-sale constraints.
                    </Typography>
                  </li>
                  <li>
                    <Typography component="div">
                      <strong>Unlimited lending/borrowing at <InlineMath math="R_f" /></strong> — Everyone can leverage or de-leverage at the same risk-free rate.
                    </Typography>
                  </li>
                </ol>
              </Grid>
        ...
        <Paper elevation={2} sx={{ p: 4, mb: 4 }}>
          ...
          <Box sx={{ p: 2, bgcolor: '#f8f9fa', borderRadius: 1, mb: 2 }}>
            <ul>
              <li>
                <Typography component="div">
                  <strong>Start with the Efficient Frontier</strong> under Markowitz optimization.
                </Typography>
              </li>
              <li>
                <Typography component="div">
                  <strong>Add a risk-free asset</strong> to obtain the <strong>Capital Market Line (CML)</strong>, which represents all efficient portfolios combining the risk-free asset and a risky portfolio.
                </Typography>
              </li>
              <li>
                <Typography component="div">
                  <strong>The market portfolio</strong> sits at the tangency point of the CML with the efficient frontier. This represents all investable assets, weighted by their market value.
                </Typography>
              </li>
              <li>
                <Typography component="div">
                  <strong>Any efficient portfolio is a mix</strong> of the risk-free asset and the market portfolio.
                </Typography>
              </li>
            </ul>
          </Box>
        ...
        <Paper elevation={2} sx={{ p: 4, mb: 4 }}>
          ...
          <ul>
            <li>
              <Typography component="div">
                <InlineMath math="R_{i,t}-R_{f,t}" /> is the excess return of asset <InlineMath math="i" /> at time <InlineMath math="t" />
              </Typography>
            </li>
            <li>
              <Typography component="div">
                <InlineMath math="R_{m,t}-R_{f,t}" /> is the excess return of the market at time <InlineMath math="t" />
              </Typography>
            </li>
            <li>
              <Typography component="div">
                <InlineMath math="\alpha_i" /> is the intercept, representing Jensen's Alpha (abnormal return)
              </Typography>
            </li>
            <li>
              <Typography component="div">
                <InlineMath math="\beta_i" /> is the slope coefficient, representing the asset's beta
              </Typography>
            </li>
            <li>
              <Typography component="div">
                <InlineMath math="\varepsilon_t" /> is the error term
              </Typography>
            </li>
          </ul>
          
          <Typography paragraph>
            In matrix form, the OLS estimator is <InlineMath math="\hat{\theta}=(X^{\!\top}X)^{-1}X^{\!\top}y" />, which produces:
          </Typography>
          <ul>
            <li>
              <Typography component="div">
                <InlineMath math="\hat{\beta}_i" /> — market risk estimate
              </Typography>
            </li>
            <li>
              <Typography component="div">
                <InlineMath math="\hat{\alpha}_i" /> — abnormal return estimate (Jensen's Alpha)
              </Typography>
            </li>
            <li>
              <Typography component="div">
                <InlineMath math="R^2" /> — fraction of variance explained by the market
              </Typography>
            </li>
          </ul>
        ...
        <Paper elevation={2} sx={{ p: 4, mb: 4 }}>
          ...
          <Box sx={{ p: 3, bgcolor: '#f8f9fa', border: '1px dashed #ccc', borderRadius: 2, mb: 3, textAlign: 'center' }}>
            ...
            <Typography variant="body2">
              X-axis: Beta (β) — Systematic risk<br />
              Y-axis: Expected excess return — E(Ri) - Rf
            </Typography>
          </Box>
          ...
          <ul>
            ...
            <li>
              <Typography component="div">
                ...
                <MuiLink href="https://www.aeaweb.org/articles?id=10.1257/0895330042162430" target="_blank" sx={{ ml: 1 }}>
                  Access the paper
                </MuiLink>
              </Typography>
            </li>
