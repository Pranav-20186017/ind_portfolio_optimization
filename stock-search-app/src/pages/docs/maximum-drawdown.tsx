    ...
    <>
      ...
      <Container maxWidth="lg" sx={{ py: 4 }}>
        ...
        <Paper elevation={2} sx={{ p: 4, mb: 4 }}>
          ...
          <Typography paragraph>
            Maximum drawdown is an important component of the <MuiLink component={Link} href="/docs/calmar-ratio">Calmar Ratio</MuiLink>, which measures the relationship between returns and risk:
          </Typography>
          ...
          <Grid container spacing={2}>
            <Grid item xs={12} md={6}>
              <Box sx={{ p: 2, border: '1px solid #e0e0e0', borderRadius: 1, height: '100%' }}>
                ...
                <Typography paragraph>
                  While <MuiLink component={Link} href="/docs/volatility">volatility</MuiLink> measures the dispersion of returns around their mean (treating upside and downside movements equally), Maximum Drawdown focuses exclusively on the worst sustained loss. A portfolio might have low volatility but still experience a significant drawdown during a specific period. Conversely, a portfolio with high volatility might have smaller maximum drawdowns if its swings are more evenly distributed between gains and losses.
                </Typography>
              </Box>
            </Grid>
            <Grid item xs={12} md={6}>
              <Box sx={{ p: 2, border: '1px solid #e0e0e0', borderRadius: 1, height: '100%' }}>
                ...
                <Typography paragraph>
                  The <MuiLink component={Link} href="/docs/ulcer-index">Ulcer Index</MuiLink> incorporates all drawdowns (not just the maximum) and considers both their depth and duration. It provides a more comprehensive view of downside risk by penalizing portfolios that remain underwater for extended periods. Maximum Drawdown captures only the single worst event, while the Ulcer Index tracks the overall "pain" experienced across all drawdown periods.
                </Typography>
              </Box>
            </Grid>
          </Grid>
          ...
          <Grid container spacing={2}>
            ...
            <Grid item xs={12} sm={6} md={4}>
              <Box sx={{ p: 2, border: '1px solid #e0e0e0', borderRadius: 1, height: '100%' }}>
                ...
                <Link href="/docs/ulcer-index" passHref>
                  <Button variant="contained" color="primary">Learn More</Button>
                </Link>
              </Box>
            </Grid>
