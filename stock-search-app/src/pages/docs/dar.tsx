...
const DrawdownAtRiskPage: React.FC = () => {
  return (
    <>
      <Head>
        <title>Drawdown at Risk for Indian Portfolios | QuantPort India Docs</title>
        <meta
          name="description"
          content="Understand Drawdown at Risk (DaR) for Indian equity portfolios. Quantify the worst-case peak-to-trough decline in your NSE/BSE investments with statistical confidence."
        />
        <meta property="og:title" content="Drawdown at Risk for Indian Portfolios | QuantPort India Docs" />
        <meta property="og:description" content="Understand Drawdown at Risk (DaR) for Indian equity portfolios. Quantify the worst-case peak-to-trough decline in your NSE/BSE investments with statistical confidence." />
        <meta property="og:type" content="article" />
        <meta property="og:url" content="https://indportfoliooptimization.vercel.app/docs/dar" />
      </Head>
